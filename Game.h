...
public:
 ...
 main menu                                                                      
  ...
  // Name: MainMenu()                                                           
  // Desc - Displays and manages menu. Also checks win condition (Shop reaches \
S rank).                                                                        
  ...
  // Desc - Attempts to combine known ingredients. If combined, quantity of ing\
redient decreased                                                               
...
private:
  ...
  Ingredient m_ingredients[PROJ2_SIZE]; //All ingredients in the game (loaded f\
rom file)                                                                       
};
